namespace BefunDebug.Pages
{
	partial class frmMain_BefunRun
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbInfoRun = new System.Windows.Forms.CheckBox();
			...
			this.tableLayoutPanel7.Size = new System.Drawing.Size(786, 568);
			...
			this.tableLayoutPanel2.Controls.Add(this.btnRun, 6, 0);
			this.tableLayoutPanel2.Controls.Add(this.edReturnCode, 7, 0);
			this.tableLayoutPanel2.Controls.Add(this.cbInfoRun, 4, 0);
			...
			this.btnRun.Location = new System.Drawing.Point(567, 3);
			...
			// edReturnCode
			// 
			this.edReturnCode.Location = new System.Drawing.Point(717, 3);
			...
			// cbInfoRun
			// 
			this.cbInfoRun.AutoSize = true;
			this.cbInfoRun.Dock = System.Windows.Forms.DockStyle.Fill;
			this.cbInfoRun.Location = new System.Drawing.Point(321, 3);
			this.cbInfoRun.Name = "cbInfoRun";
			this.cbInfoRun.Size = new System.Drawing.Size(44, 23);
			this.cbInfoRun.TabIndex = 6;
			this.cbInfoRun.Text = "Info";
			this.cbInfoRun.UseVisualStyleBackColor = true;
			// 
			// edInputCode
			// 
			this.edInputCode.AcceptsReturn = true;
			...
			this.edInputCode.Size = new System.Drawing.Size(780, 277);
			...
			this.tableLayoutPanel1.Size = new System.Drawing.Size(780, 244);
			...
			// edStdErr
			// 
			this.edStdErr.AcceptsReturn = true;
			...
			// edStdOut
			// 
			this.edStdOut.AcceptsReturn = true;
			...
			this.edStdOut.Size = new System.Drawing.Size(384, 225);
			...
			this.tabCtrlMain.Controls.Add(this.tabRun);
			...
			this.tabCtrlMain.Size = new System.Drawing.Size(800, 600);
			this.tabCtrlMain.TabIndex = 7;
			// 
			// tabRun
			// 
			this.tabRun.Controls.Add(this.tableLayoutPanel7);
			this.tabRun.Location = new System.Drawing.Point(4, 4);
			this.tabRun.Name = "tabRun";
			this.tabRun.Padding = new System.Windows.Forms.Padding(3);
			this.tabRun.Size = new System.Drawing.Size(792, 574);
			...
			// tabInfo
			// 
			this.tabInfo.Controls.Add(this.tableLayoutPanel3);
			this.tabInfo.Location = new System.Drawing.Point(4, 4);
			this.tabInfo.Name = "tabInfo";
			this.tabInfo.Padding = new System.Windows.Forms.Padding(3);
			this.tabInfo.Size = new System.Drawing.Size(792, 574);
			...
			this.tableLayoutPanel3.Controls.Add(this.tbInfoOutput, 0, 1);
			...
			this.tableLayoutPanel3.Size = new System.Drawing.Size(786, 568);
			this.tableLayoutPanel3.TabIndex = 0;
			// 
			// flowLayoutPanel1
			// 
			this.flowLayoutPanel1.Controls.Add(this.btnAllInfo);
			...
			// btnAllInfo
			// 
			this.btnAllInfo.Location = new System.Drawing.Point(588, 3);
			this.btnAllInfo.Name = "btnAllInfo";
			this.btnAllInfo.Size = new System.Drawing.Size(189, 23);
			this.btnAllInfo.TabIndex = 0;
			this.btnAllInfo.Text = "Start collecting BefunRun info";
			this.btnAllInfo.UseVisualStyleBackColor = true;
			this.btnAllInfo.Click += new System.EventHandler(this.btnAllInfo_Click);
			// 
			// tbInfoOutput
			// 
			this.tbInfoOutput.AcceptsReturn = true;
			this.tbInfoOutput.Dock = System.Windows.Forms.DockStyle.Fill;
			this.tbInfoOutput.Font = new System.Drawing.Font("Courier New", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.tbInfoOutput.Location = new System.Drawing.Point(3, 38);
			this.tbInfoOutput.Multiline = true;
			this.tbInfoOutput.Name = "tbInfoOutput";
			this.tbInfoOutput.ScrollBars = System.Windows.Forms.ScrollBars.Both;
			this.tbInfoOutput.Size = new System.Drawing.Size(780, 527);
			this.tbInfoOutput.TabIndex = 1;
			this.tbInfoOutput.WordWrap = false;
			this.tbInfoOutput.KeyDown += new System.Windows.Forms.KeyEventHandler(this.GenericTextBoxKeyDown);
			// 
			// frmMain_BefunRun
			// 
		...
		private System.Windows.Forms.CheckBox cbInfoRun;
		...
		private System.Windows.Forms.TextBox tbInfoOutput;
	}
}
